...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QPushButton, QTextEdit, QProgressBar, QLabel
...
class BlockerPage(QWidget):
    ...
    def init_ui(self):
        ...
        title = QLabel("Server Spam Blocker")
