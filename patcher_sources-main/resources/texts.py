...
Because they constantly change their details and the ports the servers run on blocking them using the in game blocking buttons is almost impossible. This method you can use to block the spam properly.Automatically blocking the servers in the Windows Firewall (How to block fake servers like Fastpath)
